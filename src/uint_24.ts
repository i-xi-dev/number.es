...
export function bitwiseAnd(a: number/* uint24 */, b: number/* uint24 */): number/* uint24 */ {
  if (isUint24(a) !== true) {
...
export function bitwiseOr(a: number/* uint24 */, b: number/* uint24 */): number/* uint24 */ {
  if (isUint24(a) !== true) {
    throw new TypeError("TODO");
  }
  if (isUint24(b) !== true) {
...
export function bitwiseXOr(a: number/* uint24 */, b: number/* uint24 */): number/* uint24 */ {
  if (isUint24(a) !== true) {
    throw new TypeError("TODO");
  }
  if (isUint24(b) !== true) {
...
export function rotateLeft(source: number/* uint24 */, amount: number): number/* uint24 */ {
