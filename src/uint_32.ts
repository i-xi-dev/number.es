...
export function bitwiseAnd(a: number/* uint32 */, b: number/* uint32 */): number/* uint32 */ {
  if (isUint32(a) !== true) {
...
export function bitwiseOr(a: number/* uint32 */, b: number/* uint32 */): number/* uint32 */ {
  if (isUint32(a) !== true) {
    throw new TypeError("TODO");
  }
  if (isUint32(b) !== true) {
...
export function bitwiseXOr(a: number/* uint32 */, b: number/* uint32 */): number/* uint32 */ {
  if (isUint32(a) !== true) {
    throw new TypeError("TODO");
  }
  if (isUint32(b) !== true) {
...
export function rotateLeft(source: number/* uint32 */, amount: number): number/* uint32 */ {
